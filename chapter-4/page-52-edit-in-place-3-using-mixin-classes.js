...
EditInPlaceMixin.prototype  = {
	...
	save: function(){
		...
		var callback = {
			...
			error : function() { console.log('Error saving value.') },
		}
...
var titleMixin = new EditInPlaceField('titleClassical', $('doc'), 'Title Here');
var currentTitleText = titleMixin.getValue();
