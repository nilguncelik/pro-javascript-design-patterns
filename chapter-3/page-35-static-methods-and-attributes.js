...
var Book = ( function() {
	...
	return function(newIsbn, newTitle, newAuthor) {  // implements Publication
		...
		// Constuctor code.
		numOfBooks++; // Keep track of how many Bookds have been instantiated with private static attribtue.

		if(numOfBooks > 50) throw new Error('Book: Onky 50 instances of Book can be created');
